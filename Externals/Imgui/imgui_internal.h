...
//#endif
	...
	IMGUI_API void          DrawTabItem(ImDrawList* draw_list, const ImRect& bb, ImGuiTabItemFlags flags, ImU32 col,int tabtype=0);//¼Ó
	IMGUI_API bool          TabTitlebar(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* docked_window);//¼Ó
